...
def test_create_file():
    ...
    logger.create_file("/ihme/forecasting/file.hdf", "input")
...
def test_turn_off_printing_provenance():
    ...
    logger = logging.getLogger("provda.test.test_provlog")
    logger.create_file("/ihme/forecasting/file.hdf", "scalars")
...
def test_show_provenance_stream():
    ...
    logger = logging.getLogger("provda.test.test_provlog")
    logger.create_file("/ihme/forecasting/file.hdf", "pafs")
    before = s.tell()
    assert before > 0
